...
//	@AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "START_MONTH"))})
	private final Month start;
	
//	@AttributeOverrides({@AttributeOverride(name = "value", column = @Column(name = "END_MONTH"))})
